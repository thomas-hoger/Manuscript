...
\subsection{Synthèse}
Nous avons vérifié dans cette section que, pour chacune des attaques de notre datasrt, la discriminabilité n’est possible qu’au regard des dimensions que nous avons définies. Nous obtenons ainsi un dataset dans lequel le risque de biais a été autant que possible réduit et que nous pourront utiliser pendant l’entraînement et l’évaluation de nos modèles, dont les expérimentations sont détaillées dans la section suivante.
