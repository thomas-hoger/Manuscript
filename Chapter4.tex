...
Certaines attaques \cite{pfcp1} ciblant spécifiquement les messages PFCP associés à la création ou à la suppression de sessions, il est indispensable d’inclure des exemples légitimes de ces mêmes procédures dans le jeu de données afin de garantir une couverture réaliste des comportements du réseau.
