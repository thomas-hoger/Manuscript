...
% - laboratory
% - cotutelle
\title{\textbf{\large Détection d’anomalies multi-domaines dans les environnements 5G à l'aide de réseaux de neurones de graphes dynamiques}}
\author{Thomas Hoger}
...
\makesomeone{boss}{1}{Philippe Owezarski}{}{} % Sera afiche en premier
%% Referee
\nreferee{2}
...
%% Judges
\njudge{5}
\makesomeone{judge}{1}{Vincent NICOMETTE}{Professeur d'Universit\'e}{Pr\'esident du Jury}
\makesomeone{judge}{2}{Eric TOTEL}{Professeur d'Universit\'e}{Membre du Jury}
\makesomeone{judge}{3}{Yassine HADJADJ-AOUL}{Professeur d'Universit\'e}{Membre du Jury}
