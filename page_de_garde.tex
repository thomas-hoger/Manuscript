...
% - laboratory
% - cotutelle
\title{\textbf{\large Détection d’anomalies multi-dimensionnelles dans un réseau 5G par Graphes Continus Dynamiques}}
\author{Thomas Hoger}
...
\makesomeone{boss}{1}{Philippe Owezarski}{Directeur de recherche}{} % Sera afiche en premier
%% Referee
\nreferee{2}
\makesomeone{referee}{1}{Xavier LAGRANGE}{Professeur}{}
\makesomeone{referee}{2}{Michaël HAUSPIE}{Maître de conférences}{}
%% Judges
\njudge{6}
\makesomeone{judge}{1}{Vincent NICOMETTE}{Professeur}{Président du Jury}
\makesomeone{judge}{2}{Xavier LAGRANGE}{Professeur}{Rapporteur}
\makesomeone{judge}{3}{Michaël HAUSPIE}{Maître de conférences}{Rapporteur}
\makesomeone{judge}{4}{Eric TOTEL}{Professeur}{Membre du Jury}
\makesomeone{judge}{5}{Yassine HADJADJ-AOUL}{Professeur}{Membre du Jury}
\makesomeone{judge}{6}{Nathalie MITTON}{Directrice de recherche}{Membre du Jury}
