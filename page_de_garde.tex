...
% - laboratory
% - cotutelle
\title{\textbf{\large Détection d’anomalies multi-domaines dans un réseau 5G par Graphes Continus Dynamiques}}
\author{Thomas Hoger}
...
\makesomeone{judge}{2}{Eric TOTEL}{Professeur}{Membre du Jury}
\makesomeone{judge}{3}{Yassine HADJADJ-AOUL}{Professeur}{Membre du Jury}
\makesomeone{judge}{4}{Nathalie MITTON}{Directrice de recherche}{Membre du Jury}
